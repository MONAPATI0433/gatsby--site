        ...
        return (
            ...
            <div>
                <Layout location={this.props.location}>
                    ...
                    <Container>
                        <h5 className="" style={{ fontFamily: '"Open Sans", Sans-serif', color: '#1e252f', fontWeight: '100px', fontSize: '17px' }}>In the age of the <strong>industry 4.0</strong> revolution, AI continues to dominate the technology & business landscape.  Under the aegis of<strong>transformation, disruption</strong>
                        ...
                        augmented intelligence in decision making.</h5>
                        <h5 className="mt-5" style={{ fontFamily: '"Open Sans", Sans-serif', color: '#1e252f', fontWeight: '100px', fontSize: '17px' }}><strong>Enterprises, GCCs, SMBs, Startups and Government Institutions</strong> are attempting to harness the power of AI to change the way they do business.  All these
                        ...
                        behind the competition, however large or pedigreed you might be</h5>
                        <h5 className="mt-5" style={{ fontFamily: '"Open Sans", Sans-serif', color: '#1e252f', fontWeight: '100px', fontSize: '17px' }}>So, where are you placed on your<strong>AI journey?</strong>   At AIQRATE, we can guide you on your journey of understanding what AI can do for you, embedding it within your
                        business strategy, functional areas and augmenting the decision-making process.</h5>
                        <h5 className="mt-5" style={{ fontFamily: '"Open Sans", Sans-serif', color: '#1e252f', fontWeight: '100px', fontSize: '17px' }}>At AIQRATE, we are here to help you with the art of the possible with AI.  Through our<strong>bespoke AI strategy frameworks, methodologies and assessments,</strong>  we
                        ...
                        competitive scenarios.</h5>
                        <h5 className="mt-5 mb-5" style={{ fontFamily: '"Open Sans", Sans-serif', color: '#1e252f', fontWeight: '100px', fontSize: '17px' }}>We are at an inflection point where AI will revolutionize the way we do business. The paradigms of customer, products, offerings, services and competition will
